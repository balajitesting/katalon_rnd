...
CustomKeywords.'lims.service.Logon.logon'('CLIAUserDagmar', '5Ed5CIkj9UQfaMZXAkDVaQ==')

String orDE1 = 'LIMS/DE1/'

WebUI.click(findTestObject(orDE1 + 'Page_Iteration/td_Accession Clinical'))

String barCode = CustomKeywords.'gh.core.TestUtil.getRandom'()
...
WebUI.setText(findTestObject(orDE1 + 'Page_Iteration/input_trackingno'), CustomKeywords.'gh.core.TestUtil.getRandom'())
...
String date = CustomKeywords.'gh.core.TestUtil.setDate'()
...
WebUI.click(findTestObject(orDE1 + 'Page_Iteration/input_reset'))
...
CustomKeywords.'gh.core.JSHandler.JCLick'(findTestObject(orDE1 + 'Page_Iteration/input_saveAccession01'), 15)
