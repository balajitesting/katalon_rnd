...
WebUI.comment('Run: ENTSW-TC-2897')

String A_Number = 'A0102371'
...
//Validation 1: CLS releases Addended report to primary whose delivery method is "Portal and Fax".
...
//Validation3: Verify that the message is displayed that it has been sent after released in LIMS.
